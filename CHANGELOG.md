...
- 提高了 webui 在记录数据较多时的初始化速度，通过优化了check_is_onboarding的判断逻辑；Improved the initialization speed of webui when recording a lot of data by optimizing the judgment logic of check_is_onboarding;
